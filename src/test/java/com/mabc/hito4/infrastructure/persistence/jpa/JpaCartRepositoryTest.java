package com.mabc.hito5.infrastructure.persistence.jpa;

import com.mabc.hito5.domain.entity.Cart;
import com.mabc.hito5.infrastructure.persistence.entity.CartEntity;
import com.mabc.hito5.infrastructure.persistence.entity.CartItemEntity;
import com.mabc.hito5.infrastructure.persistence.entity.CategoryEntity;
import com.mabc.hito5.infrastructure.persistence.entity.MarkEntity;
import com.mabc.hito5.infrastructure.persistence.entity.ProductEntity;
import com.mabc.hito5.infrastructure.persistence.repositories.CartJpaRepository;
...
class JpaCartRepositoryTest {
    ...
    void savePersistsAndMapsBack() {
        ...
        cart.addItem(ProductEntityMapper.toDomain(productEntity()),
                new com.mabc.hito5.domain.valueobject.Quantity(2));
