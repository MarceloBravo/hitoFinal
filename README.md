...
```env
DB_NAME=hito5
DB_URL=jdbc:postgresql://localhost:5432/hito5
...
También se incluye el archivo hito5.postman_collection.json, ubicado en el directorio raíz de la aplicación,  para ser importados en Postman.
