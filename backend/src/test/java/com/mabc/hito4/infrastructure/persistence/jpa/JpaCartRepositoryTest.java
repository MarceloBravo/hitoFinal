...
import com.mabc.hitoFinal.infrastructure.persistence.entity.CartEntity;
import com.mabc.hitoFinal.infrastructure.persistence.entity.CartItemEntity;
...
import com.mabc.hitoFinal.infrastructure.persistence.repositories.CartJpaRepository;
...
class JpaCartRepositoryTest {
    ...
    void savePersistsAndMapsBack() {
        ...
        cart.addItem(ProductEntityMapper.toDomain(productEntity()),
                new com.mabc.hitoFinal.domain.valueobject.Quantity(2));
